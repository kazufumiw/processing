  ...
  for(int j = 0; j <= xn; j++){
    ...
    seed_6 = j + 100;
     ...
     for(int i = 0; i < yn; i++){
       ...
       seed_5 = i + 50;
       seed_7 = i + 100;
       noiseval = noise(seed_1/resolution, seed_2/resolution, seed_3)-0.0625;
       movenoise_x = noise(seed_4/resolution, seed_5/resolution, seed_3)-0.0625;
       //movenoise_y = noise(seed_6/resolution, seed_7/resolution, seed_3);
       stroke(0+10*(pow(noiseval, 1)), 0, 100, 80);
